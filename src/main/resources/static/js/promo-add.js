...
$("#form-add-promo").submit(function(evt){
	...
	$.ajax({
		...
		data: promo,
		beforeSend: function(){
			// removendo as msg de erro e alerta
			$("span").closest('.error-span').remove();
			
			// tira o vermelho dos campos
		...
		success: function(){
			...
			$("#alert")
				...
				.text("Promocao incluida com sucesso");
		},
		statusCode:  {
			422: function(xhr){
		...
		error: function(xhr ){
			...
			$("#alert").addClass("alert alert-danger").text("Nao foi possivel salvar esta Promoção");
		},
		complete: function(){
